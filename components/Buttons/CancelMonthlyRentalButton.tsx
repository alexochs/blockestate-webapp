...
export default function CancelMonthlyRentalButton({
    rental
}: any) {
    ...
    const {
        ...
        abi: rentalsAbi,
        functionName: "cancelMonthlyRental",
    ...
    return (
        <Center flexDir={"column"}>
            ...
            {isSuccess && <Text pt=".5rem">Successfully cancelled your rental request!</Text>}
